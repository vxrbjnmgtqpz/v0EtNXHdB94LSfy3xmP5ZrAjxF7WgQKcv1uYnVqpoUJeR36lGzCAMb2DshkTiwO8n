//
// gpu_transport_shaders.mm
// Embedded Metal shaders for GPU transport control
//
...
// Make this extern "C" to avoid C++ name mangling
extern "C" const std::string kGPUTransportShaderSource = R"(
//
