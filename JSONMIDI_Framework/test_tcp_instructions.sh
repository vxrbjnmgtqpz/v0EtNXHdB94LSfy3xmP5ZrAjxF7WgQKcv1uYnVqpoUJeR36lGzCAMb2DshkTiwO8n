...
echo "Server: g++ -std=c++17 -I./include -I./build_standalone/_deps/nlohmann_json-src/include -pthread toast_server.cpp -L./build_standalone -ljsonmidi_framework -o toast_server"
echo "Client: g++ -std=c++17 -I./include -I./build_standalone/_deps/nlohmann_json-src/include -pthread toast_client.cpp -L./build_standalone -ljsonmidi_framework -o toast_client"
echo ""
