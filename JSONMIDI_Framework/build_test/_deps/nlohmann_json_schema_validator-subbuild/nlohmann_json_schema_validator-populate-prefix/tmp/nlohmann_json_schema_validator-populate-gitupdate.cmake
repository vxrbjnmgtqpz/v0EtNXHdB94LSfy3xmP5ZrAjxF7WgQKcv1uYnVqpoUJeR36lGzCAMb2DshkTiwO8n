...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "2.3.0"
  WORKING_DIRECTORY "/Users/timothydowler/Projects/MIDIp2p/JSONMIDI_Framework/build_test/_deps/nlohmann_json_schema_validator-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/timothydowler/Projects/MIDIp2p/JSONMIDI_Framework/build_test/_deps/nlohmann_json_schema_validator-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/timothydowler/Projects/MIDIp2p/JSONMIDI_Framework/build_test/_deps/nlohmann_json_schema_validator-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
