...
/**
 * @brief Core JSONADAT message structure for audio streaming
 */
class JSONADATMessage {
public:
    /**
     * @brief Message types for JSONADAT protocol
     */
...
public:
     ...
     */
    JSONADATMessage(const JSONADATMessage& other);

    /**
     * @brief Move constructor
     */
    JSONADATMessage(JSONADATMessage&& other) noexcept;

    /**
     * @brief Copy assignment operator
     */
    JSONADATMessage& operator=(const JSONADATMessage& other);

    /**
     * @brief Move assignment operator
     */
    JSONADATMessage& operator=(JSONADATMessage&& other) noexcept;

    /**
     * @brief Destructor
     */
    ~JSONADATMessage() = default;
     ...
     * @return JSONADATMessage instance
     */
    static JSONADATMessage createAudioMessage(
     ...
     * @return JSONADATMessage instance
     */
    static JSONADATMessage createStreamInfoMessage(
        uint32_t stream_id,
        SampleRate sample_rate,
        AudioQuality quality,
     ...
     * @return JSONADATMessage instance
     */
    static JSONADATMessage createControlMessage(
     ...
     * @return JSONADATMessage instance
     */
    static JSONADATMessage createErrorMessage(const std::string& error_msg);

    /**
     * @brief Create a heartbeat message
     * @return JSONADATMessage instance
     */
    static JSONADATMessage createHeartbeatMessage();
...
/**
 * @brief Utility functions for JSONADAT messages
 */
namespace utils {
    /**
