 ...
 * 
 * This class handles the conversion of real-time audio streams into JSONADAT messages
...
public:
     ...
     * Called when a JSONADAT message is ready for transmission
     */
    using MessageCallback = std::function<void(const JSONADATMessage&)>;
...
public:
     ...
     */
    JSONADATMessage createStreamInfoMessage() const;
