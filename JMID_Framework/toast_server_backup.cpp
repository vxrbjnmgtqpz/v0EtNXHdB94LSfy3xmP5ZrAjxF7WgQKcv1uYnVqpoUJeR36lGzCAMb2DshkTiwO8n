...
int main() {
    ...
    std::cout << "========================================================" << std::endl;
    std::cout << "🌐 This computer can be reached at: 192.168.1.188:8080" << std::endl;
    ...
    if (server.startServer(8080)) {
        std::cout << "✅ TOAST TCP server started on port 8080" << std::endl;
        std::cout << "🌐 Accepting connections from all IPs on 192.168.1.188:8080" << std::endl;
