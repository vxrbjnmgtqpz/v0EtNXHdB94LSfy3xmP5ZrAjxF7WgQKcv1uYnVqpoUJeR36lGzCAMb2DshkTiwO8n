...
/**
 * @brief Core JVID message structure for frame-by-frame video streaming
 */
struct JVIDMessage {
    // Message metadata
     ...
     */
    static JVIDMessage fromJSON(const std::string& json_string);
     ...
     * @return Parsed message object
     */
    static JVIDMessage fromCompactJSON(const std::string& compact_json);
 ...
 */
JVIDMessage createUltraLowLatencyFrame(
